...
namespace Utils
{
    ...
    public static class MyString
    {
        ...
        public static string[][] ReadStringMatrixFromCsv(this string fileName, bool overreadTitleLine, char seperator= ';')
        {
            ...
            {
                elements[line - subtractIndex] = lines[line].Split(seperator);
            }
            return elements;
        }
